/*
In this programm we are solving the eigenvalue problem for 1 electron in an harmonic oscillator with Householder`s algorithm
*/
#include <iostream>
#include <cmath>
#include <fstream>
...
int main()
{
    ...
    //measuring the time the algorithm takes
